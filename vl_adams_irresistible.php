...
<head>
    ...
    <link rel="stylesheet" href="./vlog_styles.css"><!--  n.b. 2nd css file -->
    <title>Tying the Adams Irresistible</title>
</head>
...
<body>
    ...
    <div class="menu">
        <div class="navbar">
            <a href="vl_adams_irresistible.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_adams_irresistible.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
        <div class="header">
            <h1><?php echo $lang['vl_gr_1_title'] ?></h1>
        </div> <!--  close div header -->

        <div class="youtube_embedded">
            <iframe width="644" height="362" src="https://www.youtube.com/embed/33-ygE-18Mw" frameborder="0"
