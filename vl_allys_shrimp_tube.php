...
<head>
    ...
    <title>Ally's Shrimp Tube Fly</title>
</head>
...
<body>
    ...
    <div class="menu">
        <div class="navbar">
            <a href="vl_allys_shrimp_tube.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_allys_shrimp_tube.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
        <div class="header">
        <h1><?php echo $lang['vl_sa_12_title'] ?></h1>
        </div><!--  close div header -->

        <div class="youtube_embedded">
        <iframe width="644" height="362" src="https://www.youtube.com/embed/B033JBmo8aA" frameborder="0"
        ...
        <p><br> <?php echo $lang['vl_sa_12'] ?></p></div>
