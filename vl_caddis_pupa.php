...
<head>
    ...
    <title>Caddis Pupa Vlog</title>
</head>

<body>
    <div class="menu">
        <div class="navbar">
            <a href="vl_caddis_pupa.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_caddis_pupa.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
        ...
        <h1 class="headline"><?php echo $lang['vl_tr_6_title'] ?></h1>
        </div><!--  close div header -->

        <div class="youtube_embedded">
        <iframe width="644" height="362" src="https://www.youtube.com/embed/eUDbSWxvVlc" frameborder="0"
