...
<head>
    ...
    <title>Peeping Caddis Vlog</title>
</head>

<body>
    <div class="menu">
        <div class="navbar">
            <a href="vl_peeping_caddis.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_peeping_caddis.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
            <div class="header">
            <h1><?php echo $lang['vl_gr_3_title'] ?></h1>
            </div> <!--  close div header -->
    
        <div class="youtube_embedded">
        <iframe width="644" height="362" src="https://www.youtube.com/embed/jXlqWatLuMo" frameborder="0"
