...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./vlog_styles.css" />
    <title>Proppen Vlog</title>
</head>
...
<body>
    ...
    <div class="menu">
        <div class="navbar">
            <a href="vl_proppen.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_proppen.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
        <div class="header">
            <h1> <?php echo $lang['vl_se_7_title'] ?></h1>
        </div>

        <div class="youtube_embedded"> 
        <iframe width="644" height="362" src="https://www.youtube.com/embed/cVMNsBd8h9M" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <!-- youtube embeded link-->
        </div>

        <div class="vlog_intro">
        <p><br> <?php echo $lang['vl_se_7'] ?></p>
        </div>
