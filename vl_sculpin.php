...
<body>
    ...
    <div class="backfill">
        <div class="header">
            <h1><?php echo $lang['vl_se_9_title'] ?></h1>
        </div> <!--  close div header -->

        <div class="youtube_embedded">
        <iframe width="644" height="362" src="https://www.youtube.com/embed/vV5MyLy_xzg" frameborder="0"
