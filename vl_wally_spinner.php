...
<head>
    ...
    <title>Wally Wing Spinner Vlog</title>
...
<body>
    <div class="menu">
        <div class="navbar">
            <a href="vl_wally_spinner.php?lang=en" target="_self">
            <img border="2" alt="EN_flag" src="./images/flagstgeorge.png"><?php echo $lang['lang_en'] ?></a>
        
            <a href="vl_wally_spinner.php?lang=fi"  target="_self">
    ...
    <div class="backfill">
        <div class="header">
            <h1><?php echo $lang['vl_tr_5_title'] ?></h1>
        </div> <!--  close div header -->
    
        <div class="youtube_embedded">
        <iframe width="640" height="362" src="https://www.youtube.com/embed/IEZf2cGFXMQ" frameborder="0"
